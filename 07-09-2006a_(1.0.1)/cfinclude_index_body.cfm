...
<cfif 0>
	...
	//		html += '</tr>';
			...
			html += '<td align="center" valign="top">';
			html += '<span class="normalx11StatusBoldClass"><a href="" onclick="alert(\'Downloads will be available soon.\'); return false;"><img border="0" src="' + imgName + '"><br>Community Edition 30-day Trial Edition FREE Download</a></span>';
			html += '</td>';
