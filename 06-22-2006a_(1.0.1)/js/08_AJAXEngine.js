				...
				switch (this.method) {
					...
					case this.Get_symbol:
						if (this._xmlHttp_reqObject.oRequest) {
							this._xmlHttp_reqObject.oRequest.onreadystatechange = function() {
						    	try {
	//								_alert('GET :: oGateway._xmlHttp_reqObject.oRequest.readyState = [' + oGateway._xmlHttp_reqObject.oRequest.readyState + ']');
	//								_alert('GET :: ' + ', bool = [' + bool + ']');
	//								_alert('GET :: ' + ', oGateway.id = [' + oGateway.id + ']');
									oGateway.processXmlHttpRequestStateChange();
							//		if (oGateway._xmlHttp_reqObject.oRequest.readyState == 4) {
							//			_alert(oGateway._xmlHttp_reqObject.oRequest.responseText);
							//		}
						        } catch(e) {
