			...
			switch (qryStruct.cfm) {
				case 'performBlogCategoryReassignment':
					if ( (IsDefined("qryStruct.namedArgs.id")) AND (IsValid('UUID', qryStruct.namedArgs.id)) AND (IsDefined("qryStruct.namedArgs.catID")) AND (IsValid('UUID', qryStruct.namedArgs.catID)) AND (IsDefined("qryStruct.namedArgs.isChecked")) AND (IsValid('boolean', qryStruct.namedArgs.isChecked)) ) {
						...
						QuerySetCell(qObj, 'errorMsg', 'Missing or Invalid ezAJAX(tm) parm(s) named (#errorDetails#) for #qryStruct.cfm# in #CGI.SCRIPT_NAME#.', qObj.recordCount);
						registerQueryFromAJAX(qObj); // this function is used to tell the ezAJAX(tm) system what Query(s) you wish to communicate back to JavaScript - you can register as many Query Objects as you wish... he CF Var named Request.qryData is used to hold an array of Query Objects...
					}
				break;
				
				case 'performPopulateBlogCategoryReassignment':
					if ( (IsDefined("qryStruct.namedArgs.id")) AND (IsValid('UUID', qryStruct.namedArgs.id)) AND (IsDefined("qryStruct.namedArgs.catIds")) ) {
						isError = false;
						sErrorMsg = '';
						try {
						...
						if (NOT isError) {
							registerQueryFromAJAX(qCategories); // this function is used to tell the ezAJAX(tm) system what Query(s) you wish to communicate back to JavaScript - you can register as many Query Objects as you wish... he CF Var named Request.qryData is used to hold an array of Query Objects...
						} else {
							qObj = QueryNew('id, errorMsg');
							QueryAddRow(qObj, 1);
							QuerySetCell(qObj, 'id', qObj.recordCount, qObj.recordCount);
				...
				case 'getDirectoryContents':
					if ( (IsDefined("qryStruct.namedArgs.levelNum")) AND (IsDefined("qryStruct.namedArgs.buttonID")) AND (IsDefined("qryStruct.namedArgs.folderName")) ) { 
						...
						QuerySetCell(qObj, 'errorMsg', 'Missing or Invalid ezAJAX(tm) parm named (#errorDetails#) for #qryStruct.cfm# in #CGI.SCRIPT_NAME#.', qObj.recordCount);
						registerQueryFromAJAX(qObj); // this function is used to tell the ezAJAX(tm) system what Query(s) you wish to communicate back to JavaScript - you can register as many Query Objects as you wish... he CF Var named Request.qryData is used to hold an array of Query Objects...
					}
				break;
				...
				case 'performGetArticleByEntry':
					if (IsDefined("qryStruct.namedArgs.id")) {
						...
						QueryAddRow(qObj, 1);
						QuerySetCell(qObj, 'id', qObj.recordCount, qObj.recordCount);
						QuerySetCell(qObj, 'errorMsg', 'Missing or Invalid ezAJAX(tm) parm named (id) for #qryStruct.cfm# in #CGI.SCRIPT_NAME#.', qObj.recordCount);
						registerQueryFromAJAX(qObj); // this function is used to tell the ezAJAX(tm) system what Query(s) you wish to communicate back to JavaScript - you can register as many Query Objects as you wish... he CF Var named Request.qryData is used to hold an array of Query Objects...
					}
				break;
				...
				case 'performSubscribePodAction':
					if ( (IsDefined("qryStruct.namedArgs.emailAddress")) AND (Len(qryStruct.namedArgs.emailAddress) gt 0) ) {
						...
						QueryAddRow(qObj, 1);
						QuerySetCell(qObj, 'id', qObj.recordCount, qObj.recordCount);
						QuerySetCell(qObj, 'errorMsg', 'Missing or Invalid ezAJAX(tm) parm named (emailAddress) for #qryStruct.cfm# in #CGI.SCRIPT_NAME#.', qObj.recordCount);
						registerQueryFromAJAX(qObj); // this function is used to tell the ezAJAX(tm) system what Query(s) you wish to communicate back to JavaScript - you can register as many Query Objects as you wish... he CF Var named Request.qryData is used to hold an array of Query Objects...
					}
				break;
				...
				case 'getDefaultBlogArticles':
					if (IsDefined("qryStruct.namedArgs.maxEntries")) {
						...
						QueryAddRow(qObj, 1);
						QuerySetCell(qObj, 'id', qObj.recordCount, qObj.recordCount);
						QuerySetCell(qObj, 'errorMsg', 'Missing or Invalid ezAJAX(tm) parm named (maxEntries) for #qryStruct.cfm# in #CGI.SCRIPT_NAME#.', qObj.recordCount);
						registerQueryFromAJAX(qObj); // this function is used to tell the ezAJAX(tm) system what Query(s) you wish to communicate back to JavaScript - you can register as many Query Objects as you wish... he CF Var named Request.qryData is used to hold an array of Query Objects...
					}
				break;
				...
				case 'getDownloadsFolder':
					if (IsDefined("qryStruct.namedArgs.folderName")) {
						...
						QueryAddRow(qObj, 1);
						QuerySetCell(qObj, 'id', qObj.recordCount, qObj.recordCount);
						QuerySetCell(qObj, 'errorMsg', 'Missing or Invalid ezAJAX(tm) parm named (folderName) for #qryStruct.cfm# in #CGI.SCRIPT_NAME#.', qObj.recordCount);
						registerQueryFromAJAX(qObj); // this function is used to tell the ezAJAX(tm) system what Query(s) you wish to communicate back to JavaScript - you can register as many Query Objects as you wish... he CF Var named Request.qryData is used to hold an array of Query Objects...
					}
				break;
