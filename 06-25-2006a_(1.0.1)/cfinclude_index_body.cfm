...
<cfif 0>
	...
	//	_alert('objectExplainer(window.location) = [' + objectExplainer(window.location) + ']');
		...
		function performOpenLoginRegisterWindow2(id) {
			...
			var oBtn3 = _$('btn_purchasePremiumButton');
...
// +++
	...
	//		html += '<span class="normalx12StatusBoldClass"><a href="" onclick="alert(\'More Info will be added soon.\'); return false;">More info &gt;&gt;</a></span>';
		...
		function populateAdminAddEntryGUI(btnObj, oDiv) {
			...
			html += '<td>';
			html += '<input type="Radio" name="radio_adminAddEntryAllowComments" id="radio_adminAddEntryAllowCommentsYes" value="Yes">&nbsp;<span class="normalStatusBoldClass">Yes</span>';
			html += '&nbsp;<input type="Radio" name="radio_adminAddEntryAllowComments" id="radio_adminAddEntryAllowCommentsNo" value="No">&nbsp;<span class="normalStatusBoldClass">No</span>';
			html += '</td>';
			html += '</tr>';
			html += '<tr>';
			html += '<td>&nbsp;</td>';
