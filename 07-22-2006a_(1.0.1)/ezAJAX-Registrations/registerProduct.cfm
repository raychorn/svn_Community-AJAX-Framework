...
<cfparam name="URL.productVersion" type="string" default="0.9">
										...
										if (NOT Request.dbError) {
											if (Request.qGetLicenseFromDb.recordCount gt 0) {
												...
												if (NOT Request.fileError) {
													...
													Request.commonCode.safely_cfmail(URL.userName, 'do-not-respond@ez-ajax.com', 'Attached is your Runtime License for ezAJAX(tm) for #URL.userName# / #URL.serverName#', do_resentProductRegistrationNotice(), optionsStruct);
												...
												if (NOT Request.dbError) {
													...
													if (NOT Request.isPKviolation) {
														...
														dataStream = 'Error 102.1 Cannot issue another Runtime License for Server Name of "" because a Runtime License was already issued for your Physical Server.  You may contact our Sales Department at sales@ez-ajax.com to purchase the Runtime Licenses you require to meet your specific needs.';
													}
												}
											}
										} else {
